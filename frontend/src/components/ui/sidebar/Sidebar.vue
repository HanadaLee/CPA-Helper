...
function handleMobileContentClick(event: MouseEvent) {
  const target = event.target
  if (target instanceof Element && target.closest('[data-sidebar="menu-button"][data-navigation="true"]')) {
    setOpenMobile(false)
  }
}
</script>
...
<template>
  ...
  <Sheet v-else-if="isMobile" :open="openMobile" v-bind="$attrs" @update:open="setOpenMobile">
    <SheetContent
      ...
      @click="handleMobileContentClick"
    >
